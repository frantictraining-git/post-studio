...
export default function T11_TastyMorning({ tpl, selectedZoneId, onSelectZone, onTextChange }) {
  const { zones } = tpl;
  return (
    <div className="tpl-wrap" style={{ backgroundColor: '#1a1a1a' }}>
      <SharedLayers tpl={tpl} />
      <div className="tpl-11-gradient" />
      <div className="tpl-11-content">
        ...
        <div className="tpl-11-bottom-row">
